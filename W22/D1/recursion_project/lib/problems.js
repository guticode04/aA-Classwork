...
function pow(base, exponent) {
    ...
    if (exponent > 0) {
        ...
        return pow(base, exponent + 1) * (1 / base);
    };
...
function fileFinder(directories, targetFile) {
    // let key;
    // if ((directories[key] === targetFile) || (fileFinder(directories[key] === targetFile))) {
    //     return true;
    // } else {
    ...
    //     if ((key === targetFile) || (fileFinder((directories[key], targetFile) === true))) return true;
    // }
    // return false;
