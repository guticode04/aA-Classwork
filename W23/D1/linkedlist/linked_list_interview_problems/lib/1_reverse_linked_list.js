...
function reverseLinkedList(linkedList) {
  ...
  let currentNode = linkedList.head; //one
  let firstNode = currentNode; //holds 'one' until the end and becomes new tail
  let nextNode = null; //currentNode.next (two)
  let prevNode = null;

  while (currentNode !== null) {
    nextNode = currentNode.next; //two
    currentNode.next = prevNode; //here one now points to null instead of two
